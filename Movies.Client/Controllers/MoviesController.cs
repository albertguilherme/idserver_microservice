    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Rating,ImageUrl,ReleaseDate,Owner")] Movie movie)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var m = await _movieApiService.UpdateMovie(movie);
                }
                catch (Exception)
                {
        ...
        {
            if (id == null || _movieApiService == null)
            {
                return NotFound();
            }
        ...
        {
            if (_movieApiService == null)
            {
                return Problem("Api Service is null");
            }
        ...
        {
          return _movieApiService.GetMovie(id) != null;
        }
    }
}
